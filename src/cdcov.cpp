...
int main()
{
    ...
    // std::vector<double> cdcov = compute_condition_distance_covariance(dx, dy, dz);
    // printVec(cdcov);

    // std::vector<double> cdcov_crude = compute_condition_distance_covariance_crude(dx, dy, dz);
    double cdcov_crude = compute_condition_distance_covariance_crude(dx, dy, dz);
    std::cout << cdcov_crude << std::endl;
